...
class ELANLNX4(nn.Module):
    def __init__(self, scale = 4, img_range = 255., colors = 3, window_sizes = [4,8,16], m_elan = 36, c_elan = 180, n_share = 0, r_expand = 2,
                 rgb_mean=(0.4488, 0.4371, 0.4040)):
        super(ELANLNX4, self).__init__()
        ...
        self.tail_x4 = nn.Sequential(*m_tail)
