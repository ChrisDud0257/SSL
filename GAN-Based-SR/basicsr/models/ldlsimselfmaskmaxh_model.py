...
from basicsr.losses.loss_util import similarity_map, get_refined_artifact_map


@MODEL_REGISTRY.register()
class LDLSimSelfMaskMaxhModel(BaseModel):
    """Base SR model for single image super-resolution."""

    def __init__(self, opt):
        super(LDLSimSelfMaskMaxhModel, self).__init__(opt)
        ...
        if self.cri_selfsim:
            ...
            for i in range(b):
                ...
                if b_mask_gt.sum() == 0:
                    ...
                    self_matrix = similarity_map(img=b_gt.clone(), mask=b_mask_gt.clone(), img_sr=b_sr.clone(),
                    ...
                    gt_self_matrix, output_self_matrix = self_matrix.getitem_simmutual()
