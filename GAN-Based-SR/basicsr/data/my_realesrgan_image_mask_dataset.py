...
class MyRealESRGANImageMaskDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(MyRealESRGANImageMaskDataset, self).__init__()
        self.opt = opt
        self.all_gt_folder = opt['dataroot_gt']
    ...
    def __getitem__(self, index):
        ...
        img_gt = imfromfile(path=os.path.join(self.all_gt_folder, img_name), float32=True)  #h*w*c, 0-1, ndarray
