    ...
    for idx, mtd in enumerate(args.folder):
        ...
        for method in methods:
            ...
            for dataset in dataset_paths:
                ...
                fid_stats_path = os.path.join(args.fid_stats[idx], dataset, 'GT', 'FID_status', f'GT_512{args.ext}.pth')
                print(f"----------------------------")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', nargs='+', default=['/home/chendu/data2_hdd10t/chendu/myprojects/ISSL_Results/Real-GAN'])
    parser.add_argument('--fid_stats', nargs='+', default=['/home/chendu/data2_hdd10t/chendu/dataset/basicsr'])
    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--num_sample', type=int, default=50000)
    parser.add_argument('--num_workers', type=int, default=1)
    parser.add_argument('--ext', type=str, default='Multi30')
