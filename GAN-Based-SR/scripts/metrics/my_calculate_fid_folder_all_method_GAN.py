    ...
    for idx, mtd in enumerate(args.folder):
        ...
        for method in methods:
            ...
            for dataset in dataset_paths:
                ...
                fid_stats_path = os.path.join(args.fid_stats[idx], dataset, 'GT', 'FID_status', 'GT_512.pth')
                print(f"----------------------------")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', nargs='+', default=['/home/chendu/data2_hdd10t/chendu/myprojects/ISSL_Results/GAN'])
