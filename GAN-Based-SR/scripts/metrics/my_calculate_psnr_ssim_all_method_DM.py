    ...
    for idx, mtd in enumerate(args.restored):
        ...
        for method in methods:
            ...
            for dataset in dataset_paths:
                ...
                gt_path = os.path.join(args.gt[idx], dataset, 'gt')
                psnr_all = []
                ssim_all = []
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--gt', nargs='+', default=['/data0/chendu/dataset/StableSR-GT-LQ'],
    #                     help='Path to gt (Ground-Truth)')
    parser.add_argument('--gt', nargs='+', default=['/home/chendu/data2_hdd10t/chendu/dataset/StableSR-GT-LQ'],
                        help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', nargs='+', default=['/home/chendu/data2_hdd10t/chendu/myprojects/ISSL_Results/ResShift-SSL-AblationStudy'], help='Path to restored images')
