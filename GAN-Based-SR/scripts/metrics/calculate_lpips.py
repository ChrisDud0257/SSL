...
def main():
    # Configurations
    # -------------------------------------------------------------------------
    folder_gt = '/home/chendu/data2_hdd10t/chendu/dataset/basicsr/DIV2K100/GT/GTmod12'
    folder_restored = '/data1_ssd4t/chendu/myprojects/EFDM_SIM/results/ELANESRGANSSL_bicubic_1_h0.004_ks25_kc9_500_x4_95500/visualization/DIV2K100'
    # crop_border = 4
    suffix = '_ELANGANSSL'
    crop_border = 4
    # -------------------------------------------------------------------------
