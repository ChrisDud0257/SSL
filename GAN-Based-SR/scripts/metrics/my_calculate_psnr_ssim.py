...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', nargs='+', default=['/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/DIV2K_V2_val/gt',
    ...
    parser.add_argument('--restored', nargs='+', default=['/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/StableSR_w0.5_results/V2_T1000_S200_117_W0.5/samples',
                                                        ...
                                                        '/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/StableSR_w0.5_results/V2_T1000_S200_117_W0.5_RealSR/samples'], help='Path to restored images')
