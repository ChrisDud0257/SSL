...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', nargs = '+', default=['/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/StableSR_w0.5_results/V2_T1000_S200_117_W0.5/samples',
                                                         '/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/StableSR_w0.5_results/V2_T1000_S200_117_W0.5_DPED/samples',
                                                         ...
                                                         '/data1_ssd4t/chendu/datasets/StableSR/StableSR-TestSets/StableSR_testsets/StableSR_w0.5_results/V2_T1000_S200_117_W0.5_RealSR/samples'], help='Input path')
