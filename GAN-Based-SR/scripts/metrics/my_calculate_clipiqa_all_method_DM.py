...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', nargs = '+', default=['/home/chendu/data2_hdd10t/chendu/myprojects/ISSL_Results/ResShift-SSL-AblationStudy'], help='Input path')
    parser.add_argument('--crop_border', type=int, default=4, help='Crop border for each side')
    parser.add_argument("--device", type=int, default=0)
    # parser.add_argument("--backbone_path", type=str, default="/data0/chendu/myprojects/EFDM_SIM/experiments/pretrained_models/clipmodels/RN50.pt")
    parser.add_argument("--backbone_path", type=str,
                        default="/data1_ssd4t/chendu/myprojects/EFDM_SIM/experiments/pretrained_models/clipmodels/RN50.pt")
