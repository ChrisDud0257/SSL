...
if __name__ == '__main__':
    ...
    parse.add_argument("--input", nargs = '+', default=["/home/chendu/data2_hdd10t/chendu/myprojects/ISSL_Results/DM/DiffIRS2_GANSSL_x4_390000/visualization/DPEDiphoneValSet_crop128"])
    parse.add_argument("--crop_border", type=int, default=4)
    parse.add_argument("--device", type=int, default=0)
    parse.add_argument("--backbone_path", type=str, default="/data1_ssd4t/chendu/myprojects/EFDM_SIM/experiments/pretrained_models/clipmodels/RN50.pt")
