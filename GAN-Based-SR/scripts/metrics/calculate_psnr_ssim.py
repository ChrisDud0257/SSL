...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/chendu/data2_hdd10t/chendu/dataset/basicsr/DIV2K100/GT/GTmod12',
                        help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/data1_ssd4t/chendu/myprojects/EFDM_SIM/results/ELANESRGANSSL_bicubic_1_h0.004_ks25_kc9_500_x4_95500/visualization/DIV2K100', help='Path to restored images')
    parser.add_argument('--crop_border', type=int, default=4, help='Crop border for each side')
    parser.add_argument('--suffix', type=str, default='_ELANGANSSL', help='Suffix for restored images')
    parser.add_argument(
        '--test_y_channel',
        action='store_true',
