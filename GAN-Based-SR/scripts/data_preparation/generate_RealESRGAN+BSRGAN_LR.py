...
import sys
sys.path.append("../../")
# sys.path.insert(0,'/home/notebook/code/personal/S9053766/chendu/myprojects/EFDM_SIM')
...
def main(args):
    ...
    for dataset, dataroot in opt['datasets'].items():
        ...
        save_LR_full_path = args.save_LR_path
        save_bicubicSR_full_path = args.save_bicubicSR_path
        ...
        for file in os.listdir(dataroot['dataroot']):
            if random.random() > 0.4:
                ...
                cv2.imwrite(os.path.join(save_LR_full_path, f'{img_name}.png'), lq)
                cv2.imwrite(os.path.join(save_bicubicSR_full_path, f'{img_name}_bicubic.png'), bicubicSR)
            else:
...
if __name__ == '__main__':
    ...
    parse.add_argument('--param_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/myprojects/SSL/options/generate/generate_RealESRGAN+BSRGAN_LR.yml')
    parse.add_argument('--save_LR_path', type=str, default='/home/notebook/data/group/chendu/dataset/DIV2K100/LRx4')
    parse.add_argument('--save_bicubicSR_path', type=str, default='/home/notebook/data/group/chendu/dataset/DIV2K100/BicubicSRx4')
