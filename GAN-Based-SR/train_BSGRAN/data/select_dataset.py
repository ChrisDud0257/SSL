...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['multilr_onegt']:
        from data.dataset_multilronegt import DatasetMultiLROneGT as D
    ...
    elif dataset_type in ['blindsroursp']:
        from data.dataset_blindsroursp import DatasetBlindSROursP as D

    elif dataset_type in ['blindsrmask']:
        from data.dataset_blindsrmask import DatasetBlindSRMask as D
